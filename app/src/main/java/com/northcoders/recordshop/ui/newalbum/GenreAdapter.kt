...
import com.northcoders.recordshop.databinding.SpinnerGenreItemBinding
...
class GenreAdapter : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val binding: SpinnerGenreItemBinding = DataBindingUtil.inflate(
            LayoutInflater.from(parent?.context),
            R.layout.spinner_genre_item,
            parent,
            false
        )

        val item = getItem(position) as Genre
